...
myScratchpads =
              ...
              , NS "quick-nautilus"    "nautilus ~/Documentos"                                     (resource =? "quickNautilus") myTermPosition
              ...
              , NS "rtorrent" "urxvt -name rtorrent -e rtorrent"                                     (resource =? "rtorrent") myPosition
                ...
                myTermPosition = customFloating $ W.RationalRect (1/5) (1/5) (2/3) (1/3)
                myPositionBiggerSW = customFloating $ W.RationalRect (1/2) (1/2) (1/2) (1/2)  
                myPositionBiggerSE = customFloating $ W.RationalRect (1/3) (1/3) (1/2) (1/2)
...
myLogHook h = dynamicLogWithPP ( defaultPP
	{
		...
		, ppLayout		= wrap "^ca(1,xdotool key super+space)" "^ca()" . dzenColor color2 background .
				(\x -> case x of
					"Full"				->	"^i(/home/trycatch/.xmonad/dzen2/layout_full.xbm)"
					"Spacing 5 ResizableTall"	->	"^i(/home/trycatch/.xmonad/dzen2/layout_tall.xbm)"
					"ResizableTall"			->	"^i(/home/trycatch/.xmonad/dzen2/layout_tall.xbm)"
					"SimplestFloat"			->	"^i(/home/trycatch/.xmonad/dzen2/mouse_01.xbm)"
					"Circle"			->	"^i(/home/trycatch/.xmonad/dzen2/full.xbm)"
					_				->	"^i(/home/trycatch/.xmonad/dzen2/grid.xbm)"
				)
...
myStatusBar = "/home/trycatch/.xmonad/status_bar '"
              ++
              foreground ++ "' '" ++
              background ++"' "++
              myFont
...
main = do
  -- xmproc <- spawnPipe "xmobar /home/trycatch/.xmonad/xmobarrc"
  ...
  , startupHook = do
      setWMName "LG3D"
      spawn "/home/trycatch/.xmonad/startup-hook"
...
myKeyBindings =
  [
        ...
        , ("M-p", spawn "exe=`dmenu_path | dmenu_run -fn Monaco-72` && eval \"exec $exe\"")
    ...
    -- Apps
        ...
        -- Google Apps
        , ("M-S-h",             spawn "google-chrome --app=https://dev-tam.slack.com")
        , ("M-s",               spawn "google-chrome --app=https://gitlab.com/dashboard")
        , ("M-m",               spawn "google-chrome --app=https://maps.google.com")

        -- Utility
        -- , ("<Print>",           spawn " sleep 0.2; scrot -e 'mv $f /home/trycatch/Pictures/Screenshots/' & mplayer /usr/share/sounds/freedesktop/stereo/screen-capture.oga")
        -- , ("M-<Print>",         spawn " sleep 0.2; scrot -s -e 'mv $f /home/trycatch/Pictures/Screenshots/' & mplayer /usr/share/sounds/freedesktop/stereo/screen-capture.oga")
